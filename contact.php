  ...
  <head>
    <?php include("include/header.php");?>
     ...
     <script type="text/javascript">
        ...
        $("#flash").html('<img src="img/loader.gif" />');
        },
         ...
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="" method="POST">
                ...
                <input type="text" class="wp-form-control wpcf7-text"  id="full_name" placeholder="Your name">
                <input type="mail" class="wp-form-control wpcf7-email" id="email" placeholder="Email address">          
                <input type="text" class="wp-form-control wpcf7-text" id="subject" placeholder="Subject">
                <textarea class="wp-form-control wpcf7-textarea" cols="30" id="message" rows="10" placeholder="What would you like to tell us"></textarea>
                <input type="submit" value="Submit" id="submit" class="wpcf7-submit">
              </form>
           </div>
         </div>
